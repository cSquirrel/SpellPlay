...
class AchievementService {
    ...
    func checkAchievements(
        ...
        if sessionResults.helpCoinsUsed == 0 && sessionResults.wordsAttempted > 0 && !userProgress.hasAchievement(.noHelpNeeded) {
        ...
        if sessionResults.hadInitialMistakes && sessionResults.allWordsMastered && !userProgress.hasAchievement(.comebackKid) {
